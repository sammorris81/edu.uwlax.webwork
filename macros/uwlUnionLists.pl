...
sub _uwlUnionLists_init {}; # don't reload this file
...
=head2 unionLists.pl
 ...
 #                              (default is 0)
 #
 #    itemsep => num            Set spacing between list items in em.
 #
 #  Example:
 #
 #    BEGIN_TEXT
...
sub BeginList {
  ...
  $tex .= "\\itemsep".$options{itemsep}."em" if (defined($options{itemsep}));
